...
cp "$SRC_DIR/$MOD_NAME.dll.config" "$MOD_DIR/"
cp "$SRC_DIR/System.Data.SQLite.dll.config" "$MOD_DIR/"
cp "$SRC_DIR/SkiaSharp.dll.config" "$MOD_DIR/"
cp "$SRC_DIR/ModInfo.xml" "$MOD_DIR/"
